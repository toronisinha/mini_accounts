...
<body>
	...
	<div class="row">
		...
		<div class="col-md-9">
			<h2 class="text-center  text-dark">New Expenses Add In Here<hr></h2>
			<div class="row">
				<div class="col-md-3 ">
					
				</div>
				<div class="col-md-6 bgcolor2">
					...
					<form action="#" method="post">
						...
						<div class="form-group">
							<label>Expenses type  id</label>
							<input class="form-control" type="number" name="exptype_id" placeholder="Expenses type  id">
						</div>
						<div class="form-group">
							<label>Amount</label>
						...
						<div class="form-group">
						     ...
						     <span 	for="payment_method">payment_method</span>
						...
						<div class="form-group">
							<label>expenses_date</label>
							<input class="form-control" type="date" name="expenses_date" placeholder="expenses_date">
						</div>
						<div class="form-group">
							<label>remark</label>
