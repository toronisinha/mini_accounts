	...
	<div class="row">
		...
		<div class="col-md-9">
				...
				<div class="form-group">
					<label>user_id</label>
					<input class="form-control" type="number" name="user_id" value="?php echo $row['exptype_id'] ?>">
				</div>
				<div class="form-group">
					<label>exptype_id</label>
					<input class="form-control" type="number" name="exptype_id" placeholder="<?php echo $row['exptype_id'] ?>">
				</div>
				<div class="form-group">
					<label>amount</label>
				...
				<div class="form-group">
					...
					<input class="form-control" type="date" name="expensese_date" placeholder="expenses_date">
				</div>
				<div class="form-group">
					<label>remark</label>
