...
<body>
	...
	<div class="row">
		...
		<div class="col-md-9">
            <h3 class="lead"><i class="fa fa-dashboard"></i> Dashbord</h3><hr>
            <div class="row">
	            <div class="col-md-6">
	            	<h2 class="text-center font_color">Latest 10 Incomes</h2>
	            </div>
	              <div class="col-md-6">
	            	<h2 class="text-center font_color">Latest 10 Expenses</h2>
	            </div>
            </div>
